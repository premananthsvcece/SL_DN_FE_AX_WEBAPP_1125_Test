...
export default function AddCustomer({ onSuccess, onClose, selectedCustomer, salesType: initialSalesType, source,routerPush }) {
  ...
  const [dlgFuelType, setDlgFuelType] = useState("");
        ...
        try {
          ...
          if (response.ok) {
            ...
            if (vehicles.length > 0) {
              ...
              setRegistrationDate(firstVehicle.registrationDate || "");
              setChassisNumber(firstVehicle.chassisNumber || "");
              setEngineNumber(firstVehicle.engineNumber || "");
            ...
            <Box>
              <FormControl component="fieldset">
                ...
                <RadioGroup
                  ...
                  name="fuelTypeDialog"
                  value={dlgFuelType}
                  onChange={(e) => setDlgFuelType(e.target.value)}
                >
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    if (added) {
                      ...
                      setRegistrationDate(added.registrationDate || dlgRegistrationDate);
                      setChassisNumber(added.chassisNumber || dlgChassisNumber);
                      setEngineNumber(added.engineNumber || dlgEngineNumber);
